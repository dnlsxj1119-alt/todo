...
export default function App() {
  ...
  const { items, loading, addItem, addRecurringItems, updateItem, deleteItem, toggleComplete, setStatus, setPriority, setProject, reorderItems, moveItem, getItemsForDate, getItemsForCell, getBacklogItems } = useItems(userId);
